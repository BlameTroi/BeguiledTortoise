// Code taken from the Tutorial Introduction to Guile
// found at https://www.gnu.org/software/guile/docs/guile-tut/tutorial.html
// works.
...
tortoise_move (SCM length)
{
  ...
  return scm_list_2 (scm_from_double (x),
                     scm_from_double (y));
}
